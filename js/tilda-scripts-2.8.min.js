...
window.isSearchBot = !1,
  ...
  function(e) {
    ...
    t.prototype.defaultConfig = {
      ...
      for (var t, o, i, n, r = e.items, a = null, s = 0, c = r.length; s < c; s++)
        if ((t = r[s].node).querySelector(".txt-holder"), (n = t.getBoundingClientRect()).top < this.itemTransitionTop && n.bottom < n.height + this.itemTransitionTop && n.bottom > this.itemTransitionTop) {
          a = s;
          break
        }
      if (null != a) {
      ...
      e(document).ready(function() {
        var i = document.body.querySelector("#coverCarry" + t),
          ...
          a = n.attr("data-content-cover-height"),
          s = n.attr("data-content-cover-parallax"),
          c = n.attr("data-content-video-url-mp4"),
          d = n.attr("data-content-video-url-webm"),
          l = n.attr("data-content-video-url-youtube"),
        ...
        if (v.length && v.load(function() {
          ...
          if ("" != l || "" == c && "" == d) {
            ...
            if (n.css("background-color", "#000000"), n.css("background-image", "url('https://tilda.ws/img/spinner-white.gif')"), n.css("background-size", "auto"), n.attr("data-content-cover-bg", ""), "" != h) var m = !1;
            else m = !0;
            if ("" != u) var g = 1;
            else g = "";
            var w, y = "";
    ...
    function r(t, o) {
      ...
      if (a > 0 && (s = 1 * parseFloat(a)), "yes" != n) {
        ...
        var h = l,
          ...
          p = y,
          f = 1;
        if ("yes" == r || (u = u + 110 + 110, p = y - 220), p < d)
          if (y < d) f = d / y + .02;
          else f = y / d + .02;
        var v = Math.floor(h * f),
          m = Math.floor(u * f),
          g = m - d,
          w = v - l;
    ...
    window.processYoutubeVideo = function(t, o) {
      ...
      n.then(function() {
        var n, a = e(t),
          s = a.attr("data-content-video-url-youtube"),
          c = a.attr("data-content-video-nomute"),
          d = a.attr("data-content-video-noloop"),
          l = a.attr("data-content-video-nocover"),
  ...
  function(e) {
    e(document).ready(function() {
      if (0 == $isMobile && "yes" !== e("#allrecords").attr("data-blocks-animationoff") && 0 == window.isSearchBot) {
        ...
        function i() {
          if (t.length)
            for (var i, n = t.length - 1; n >= 0; n--)(i = e(t[n])).offset().top < o.scrollTop() + o.height() - 100 && (i.removeClass("r_hidden"), i.addClass("r_showed"), t.splice(n, 1))
        }
        t.each(function(t) {
  ...
  function(e) {
    e.fn.videoBG = function(t, o) {
      ...
      if (i.length) {
        ...
        return o.scale && n.height(o.height).width(o.width), i.append(n),
          function(t, o) {
            ...
            var r = i.find("video"),
              ...
              s = i.attr("data-content-video-ratio"),
              c = .5625;
      ...
      var o, i = e(window).width(),
        n = e(window).height();
      if (t.css("min-height", 0).css("min-width", 0), t.parent().width(i).height(n), i / n > t.aspectRatio) t.width(i).height("auto"), (o = (t.height() - n) / 2) < 0 && (o = 0), t.css("top", -o);
      else if (t.width("auto").height(n), (o = (t.width() - i) / 2) < 0 && (o = 0), t.css("left", -o), 0 === o) setTimeout(function() {
  ...
  function(e) {
    Tilda.sendEventToStatistics = function(t, o, i, n) {
      var r = "/" == t.substring(0, 1),
        a = [],
        s = 0,
        c = e("#allrecords").data("fb-event");
      if (c = !(!c || "nosend" != c), i || (i = window.location.href), (n = n ? parseFloat(n) : 0) > 0)
        if (window.dataLayer || (window.dataLayer = []), -1 != t.indexOf("/tilda/") && -1 != t.indexOf("/payment/") && window.tildaForm && window.tildaForm.orderIdForStat > "")(i = {
          ecommerce: {
            purchase: {
              actionField: {
        ...
        else if (i && i.ecommerce && (i.ecommerce.add && i.ecommerce.add.products ? a = i.ecommerce.add.products : i.ecommerce.remove && i.ecommerce.remove.products && (a = i.ecommerce.remove.products), a && a.length > 0)) {
      ...
      if (window.mainMetrika > "" && window[window.mainMetrika] && (r ? n > 0 ? window[window.mainMetrika].hit(t, {
          ...
          title: o
        }) : n > 0 ? window[window.mainMetrika].reachGoal(t, {
          title: o,
          params: i,
          order_price: n
        ...
        if (r) {
          var p = e("#allrecords").data("tilda-currency"); - 1 == t.indexOf("tilda/") || -1 == t.indexOf("/payment/") && -1 == t.indexOf("/submitted/") ? -1 != t.indexOf("tilda/popup") ? window.fbq("track", "ViewContent", {
            content_name: o,
        ...
        } else window.fbq("track", t, {
          content_name: o,
          value: n
        });
      "function" == typeof window.tildastat && (r ? (t.indexOf("payment") > 0 && t.indexOf("tilda/form") > -1 && (t = t.replace("tilda/form", "tilda/rec")), window.tildastat("pageview", {
        page: t
      ...
      8 != o && 9 != o || e(".t-btn").each(function() {
      ...
      }), Tilda.saveUTM(), e(".r").off("click", "a.js-click-stat"), e(".r").on("click", "a.js-click-stat", function(t) {
        ...
        if (o || (o = "/tilda/click/".$(this).closest(".r").attr("id") + "/?url=" + n), Tilda.sendEventToStatistics(o, i), "http" == n.substring(0, 4)) return window.setTimeout(function() {
          var t, o, i = "",
            a = "";
          if ("_blank" == r) {
            if (-1 != n.indexOf("?") && (i = n.split("?"), n = i[0], -1 != (i = i[1]).indexOf("#") && (i = i.split("#"), n = n + "#" + i[1], i = i[0]), i = i.split("&")), 0 == e("#tildaredirectform").length ? e("body").append('<form id="tildaredirectform" target="_blank" method="GET" action="' + n + '" style="display:none;"></form>') : e("#tildaredirectform").attr("method", "GET").attr("action", n), a = "", i.length > 0)
